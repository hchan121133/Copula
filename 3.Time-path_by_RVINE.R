...
#   3) Fit r-vine copula on 60D U (forced)
...
# - Includes "How to confirm it's r-vine" section
...
TRUNC_LEVEL <- 3        # ★ 60차원 계산량 제어 레버 ★ (2~3 권장)

familyset   <- c(1, 3, 4, 5, 6, 13, 14, 16)
...
# - Primary: RVineStructureSelect(U, ...)

# - Fallback: RVineStructureSelect(U, type="rVine", trunclevel=TRUNC_LEVEL, ...)
